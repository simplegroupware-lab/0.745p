<?php
	...
	* FILE HISTORY:                                                            *
	*                                                                          *
	* Patch by Vlad Zaritsky 2014-11-20 security                               *
	* -Default CHMOD_DIR set to 755, Default CHMOD_FILE set to 644             *
	* -Default value ENABLE_ANONYMOUS and ENABLE_ANONYMOUS_CMS set to zero     *
	* *Also recomended to remove/rename /bin/console.php if you do not use     *
	* Server web-based administration thru Simple Groupware                    *
	*                                                                          *
	* ------------------------------------------------------------------------ *
...
define("CHMOD_DIR",755);
define("CHMOD_FILE",644);
define("DB_SLOW",0.5);
...
function install() {
  ...
  $vars = array(
	...
	"ENABLE_ANONYMOUS"=>"0", "ENABLE_ANONYMOUS_CMS"=>"0", "DISABLE_BASIC_AUTH"=>"0", "MOUNTPOINT_REQUIRE_ADMIN"=>"0", 
	...
	"SYSTEM_SLOW"=>"2", "DB_SLOW"=>"0.5", "CMS_SLOW"=>"2", "CHMOD_DIR"=>"755", "CHMOD_FILE"=>"644",
