...
INSTALLATION:
    ...
    - unpack and overwrite files from today patch file named SimpleGroupware_0.745.zv..tar.gz


**1 Directory description**

 This tar archive consist Simple Groupware patches with keeping original file tree structure
 Version SGW 0.745
